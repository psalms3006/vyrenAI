...
The base prompt is always sent. Memory context is appended at startup
so VYREN walks into every conversation already knowing your facts.
"""
...
- Remember and recall facts across restarts (persistent memory)
...
def build_system_prompt(memory_context: str = "") -> str:
    """Build the full system prompt with optional memory context appended."""
    if memory_context:
        return BASE_PROMPT + "\n\n" + memory_context
    return BASE_PROMPT